class SheinModel {
  ...
  // covert data from json to Dart object
  ...
  // covert data from Dart object to json
...
class ProductDetails {
  ...
  String? sellerRating;
  String? sellerSlug;
  dynamic sellerSeoPageTitle;
  dynamic sellerSeoMetaKeywords;
  dynamic sellerSeoMetaDescription;
  dynamic sellerSeoOgImage;
...
class Variants {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['swatche_value'] = swatcheValue;
    if (imagesMd != null) {
      data['images_md'] = imagesMd!.map((v) => v).toList();
    }
    if (imagesSm != null) {
      data['images_sm'] = imagesSm!.map((v) => v).toList();
    }
    if (variantRelativePath != null) {
      data['variant_relative_path'] = variantRelativePath!
          .map((v) => v.toJson())
          .toList();
    }
